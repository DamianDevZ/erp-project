 ...
 *     <CardDescription>View and edit driver information</CardDescription>
 *   </CardHeader>
 *   <CardContent>
 *     <p>Content here...</p>
 *   </CardContent>
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className = '', ...props }, ref) => (
    <h3 ref={ref} className={`text-xl font-semibold leading-none tracking-tight text-heading ${className}`} {...props} />
  )
);
