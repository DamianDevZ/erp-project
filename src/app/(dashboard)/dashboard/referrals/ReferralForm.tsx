...
export function ReferralForm({ referral, isEditing = false }: ReferralFormProps) {
  ...
  // Form state
  const [referredByEmployeeId, setReferredByEmployeeId] = useState(referral?.referred_by_employee_id || '');
  ...
  const [positionApplied, setPositionApplied] = useState(referral?.position_applied || '');
  ...
  const [bonusPaid, setBonusPaid] = useState(referral?.bonus_paid || false);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!referredByEmployeeId || !referredName || !referredPhone) {
      ...
      <Card className="mb-6">
        ...
        <CardContent className="pt-6">
          <div className="space-y-2">
            <Label htmlFor="referredBy" required>Employee</Label>
            {loadingEmployees ? (
              ...
              <select
                id="referredBy"
                value={referredByEmployeeId}
                onChange={(e) => setReferredByEmployeeId(e.target.value)}
                required
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., Friend, Cousin, Former colleague"
              />
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input
                ...
                placeholder="e.g., Delivery Rider, Driver, Supervisor"
              />
            </div>
          </div>
        </CardContent>
